...
" Modified {{{1
hi Normal ctermfg=black ctermbg=NONE guifg=black guibg=#E8E8E8
hi! link NonText Normal
"hi NonText    gui=NONE guifg=#4000ff guibg=#F0FFF0
hi Title      gui=NONE guifg=#1014AD guibg=NONE
hi FoldColumn gui=NONE guibg=NONE guifg=black
hi Statement  term=BOLD ctermfg=DarkRed gui=NONE guifg=brown

hi StatusLine   term=BOLD,reverse cterm=NONE ctermfg=Blue ctermbg=Gray guibg=DarkGray guifg=Blue gui=NONE
hi StatusLineNC term=BOLD,reverse cterm=NONE ctermfg=Black ctermbg=Gray guibg=DarkGray guifg=Black gui=NONE

hi ErrorMsg gui=NONE guifg=Red guibg=NONE

hi IncSearch cterm=UNDERLINE ctermfg=Black ctermbg=brown gui=UNDERLINE guifg=Black guibg=Orange
hi Search term=reverse cterm=UNDERLINE ctermfg=Black ctermbg=brown gui=NONE guifg=Black guibg=#FFE568

hi Cursor       guibg=#00c000
"hi lCursor      gui=NONE guifg=#f8f8f8 guibg=#8000ff
hi CursorIM     guibg=#902000
hi CursorLine   guifg=NONE guibg=#c0c0c0

" Private {{{1
hi MyBrackets		guifg=DarkRed
hi SpecialKey	guifg=#b0b0b0
hi ZenkakuSpace cterm=underline ctermfg=darkgrey gui=underline guifg=darkgrey

hi Number   term=UNDERLINE ctermfg=red gui=NONE guifg=#00a206
